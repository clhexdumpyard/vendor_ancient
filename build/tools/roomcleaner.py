...
removal_manifest = ".repo/local_manifests/00_ancient_removals.xml"
tmp_removal_manifest = ".repo/local_manifests/tmp_ancient_removals.xml"
...
def add_to_manifest_dependencies(repositories):
    ...
    for repository in repositories:
        ...
        if existing_project != None:
            print('Remove-project for %s already exists' % (repo_name))
            continue
...
def fetch_dependencies(repo_path):
    ...
    dependencies_path = repo_path + '/ancient.removal.dependencies'
    syncable_repos = []
...
def remove_removals(removal_manifest):
    tmp_manifest_disable = ".repo/local_manifests/local_ancient.xml"
