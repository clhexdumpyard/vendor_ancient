...
ifeq ($(ANCIENT_GAPPS), true)
ANCIENT_VERSION := AncientOS-S-Alpha-$(ANCIENT_BASE_EDITION)-$(BUILD_VERSION)-$(ANCIENT_BUILD)-$(ANCIENT_BUILD_TYPE)-$(ANCIENT_BUILD_DATE)-GApps
else
ANCIENT_VERSION := AncientOS-S-Alpha-$(ANCIENT_BASE_EDITION)-$(BUILD_VERSION)-$(ANCIENT_BUILD)-$(ANCIENT_BUILD_TYPE)-$(ANCIENT_BUILD_DATE)-Vanilla
endif
