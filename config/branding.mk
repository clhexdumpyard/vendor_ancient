...
ANCIENT_VERSION_CUSTOM := Weeabo-v6.1
else
ANCIENT_BASE_EDITION := Shield
ANCIENT_VERSION_CUSTOM := Shield-v6.1
endif
BUILD_VERSION := v6.1
...
ifeq ($(ANCIENT_GAPPS), true)
ANCIENT_VERSION := AncientOS-S-Beta-$(ANCIENT_BASE_EDITION)-$(BUILD_VERSION)-$(ANCIENT_BUILD)-$(ANCIENT_BUILD_TYPE)-$(ANCIENT_BUILD_DATE)-GApps
else
ANCIENT_VERSION := AncientOS-S-Beta-$(ANCIENT_BASE_EDITION)-$(BUILD_VERSION)-$(ANCIENT_BUILD)-$(ANCIENT_BUILD_TYPE)-$(ANCIENT_BUILD_DATE)-Vanilla
endif
